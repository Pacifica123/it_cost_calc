...
from it_cost_calc.application.use_cases.build_npv_report import BuildNpvReportUseCase
...
class NPVTab(ttk.Frame):
    def __init__(self, parent, build_npv_report_use_case: BuildNpvReportUseCase):
        ...
        ttk.Button(
            left_frame, text="📊 Рассчитать NPV", bootstyle=SUCCESS, command=self.calculate_and_plot
