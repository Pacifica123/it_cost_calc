...
_EXPORTS = {
    ...
    "DecisionSensitivityAnalysisService": "application.services.decision_sensitivity_analysis_service",
    ...
    "ScopedCandidatePoolService": "application.services.scoped_candidate_pool_service",
