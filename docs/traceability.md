...
| NPV-анализ | Расчёт инвестиционной эффективности | `src/ui_qt/screens/npv.py`, `src/application/services/npv_report_service.py`, `src/domain/finance/` | данные вводятся вручную; сценарий можно воспроизвести через `scripts/run_app.py` |
